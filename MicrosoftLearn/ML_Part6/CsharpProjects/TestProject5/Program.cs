...
{
    int avalibleTwenties = cashTill[3] + twenties;
    int avalibleTens = cashTill[2] + tens;
    int avalibleFives = cashTill[1] + fives;
    int avalibleOnes = cashTill[0] + ones;
    ...
    while ((changeNeeded > 19) && (avalibleTwenties > 0))
    {
        avalibleTwenties--;
        changeNeeded -= 20;
    ...
    while ((changeNeeded > 9) && (avalibleTens > 0))
    {
        avalibleTens--;
        changeNeeded -= 10;
    ...
    while ((changeNeeded > 4) && (avalibleFives > 0))
    {
        avalibleFives--;
        changeNeeded -= 5;
    ...
    while ((changeNeeded > 0) && (avalibleOnes > 0))
    {
        avalibleOnes--;
        changeNeeded -= 1;
    ...
    cashTill[0] = avalibleOnes;
    cashTill[1] = avalibleFives;
    cashTill[2] = avalibleTens;
    cashTill[3] = avalibleTwenties;
}
